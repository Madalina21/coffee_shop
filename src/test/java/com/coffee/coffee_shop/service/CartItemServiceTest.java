...
class CartItemServiceTest {
    ...
    void canAddNewProductToCart() {
        ...
        //dandu-se metoda de findById din service ma astept sa imi returneze produsul
        given(productService.findById(anyLong())).willReturn(product3);
        //ma astept sa imi returneze null in cart pentru ca inca n-am adaugat nimic
        given(cartItemRepository.findCartItemByUserIdAndProductId(anyLong(), anyLong())).willReturn(null);
        //adaug produsul in cart cu cantitatea si id-ul
        CartItem newCartItem = new CartItem(3L, (short) 3, user, product3);
        //sa imi salveze cartul cu produsul
    ...
    void canAddExistentProductToCart() {
        ...
        //ma astept sa imi returneze prod1 care e pe pozitia 0 in cart in setup
