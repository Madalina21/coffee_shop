...
class ProductServiceTest {
    ...
    void findProductById_ExceptionTest() {
        ...
        // then
        //testam sa vedem daca a fost aruncata exceptie apartinand clasei ProductNotFound
        //cand apelez findById sa imi arunce exceptie ProductNotFound
    ...
    private List<Product> createListOfProducts() throws IOException {
        ...
        // fol streamuri  = secventa de obiecte care suporta diverse operatii
        List<String> wordList = Files
                .lines(Paths.get("src/main/greatexpectations.txt"))  // get the lines from a text file as a stream//line by line
                .map(line -> line.split("[^A-Za-z]")) //aplica regexul pt fiecare cuvant in parte(split) a.i. sa ramana doar litere
